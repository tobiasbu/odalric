...
#include "OdarichAIModule.h"
#include "TerrainAnalyzer.h"

namespace Odarich {

	OdarichAIModule::OdarichAIModule()
		:
	...
	void OdarichAIModule::onStart()
	{
		...
		BWAPI::Broodwar->printf("Odarich bot. v%d.%d - bwapi 4.1.2", ODARICH_VERSION_MAJOR, ODARICH_VERSION_MINOR);
	...
	void OdarichAIModule::onEnd(bool isWinner)
	{
		resourcesArea.dispose();
		TerrainAnalyzer::getInstance().dispose();
	...
	void OdarichAIModule::onSendText(std::string text)
	{
	...
	void OdarichAIModule::onReceiveText(BWAPI::Player player, std::string text)
	{
		// Parse the received text
		BWAPI::Broodwar << player->getName() << " said \"" << text << "\"" << std::endl;
	}

	void OdarichAIModule::onPlayerLeft(BWAPI::Player player)
	{
	...
	void OdarichAIModule::onNukeDetect(BWAPI::Position target)
	{
	...
	void OdarichAIModule::onUnitDiscover(BWAPI::Unit unit)
	{
	}

	void OdarichAIModule::onUnitEvade(BWAPI::Unit unit)
	{
	}

	void OdarichAIModule::onUnitShow(BWAPI::Unit unit)
	{
	...
	void OdarichAIModule::onUnitHide(BWAPI::Unit unit)
	{
	}

	void OdarichAIModule::onUnitCreate(BWAPI::Unit unit)
	{
		/*if (BWAPI::Broodwar->isReplay())
		{
	...
	void OdarichAIModule::onUnitDestroy(BWAPI::Unit unit)
	{
		workers.onUnitDestroy(unit);
	}

	void OdarichAIModule::onUnitMorph(BWAPI::Unit unit)
	{
	...
	void OdarichAIModule::onUnitRenegade(BWAPI::Unit unit)
	{
	}

	void OdarichAIModule::onSaveGame(std::string gameName)
	{
		BWAPI::Broodwar << "The game was saved to \"" << gameName << "\"" << std::endl;
	}

	void OdarichAIModule::onUnitComplete(BWAPI::Unit unit)
	{
	}
